...
/* configure sound for haier g151 */
...
/* configure sound for haier g101 */
#ifdef CONFIG_MACH_G101
...
#undef S
	...
	btn_low[3] = 450;
	btn_high[3] = 450;
	btn_low[4] = 450;//JRD. modify for nomad device detection #4
	btn_high[4] = 450;
#else	 
	btn_low[0] = 75;
	btn_high[0] = 75;
