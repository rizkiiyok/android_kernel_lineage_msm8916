...
//add by wkh begin
    ...
    u32 irq_gpio ;
	u32 reset_gpio;
    int MS_TS_MSG_IC_GPIO_RST ,MS_TS_MSG_IC_GPIO_INT;
#endif
//add end
/*=============================================================*/
...
s32 DrvPlatformLyrInputDeviceInitialize(struct i2c_client *pClient)
{
    ...
    { 
		...
		input_set_capability(g_InputDevice, EV_KEY, g_TpVirtualKey[0]);
		input_set_capability(g_InputDevice, EV_KEY, g_TpVirtualKey[1]);
		input_set_capability(g_InputDevice, EV_KEY, g_TpVirtualKey[2]);
    }
