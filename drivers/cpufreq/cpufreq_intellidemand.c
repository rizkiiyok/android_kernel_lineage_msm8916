...
static void cpufreq_intellidemand_early_suspend(struct power_suspend *h)
{
	mutex_lock(&dbs_mutex);
...
static void cpufreq_intellidemand_late_resume(struct power_suspend *h)
{
	mutex_lock(&dbs_mutex);
...
static struct power_suspend cpufreq_intellidemand_early_suspend_info = {
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	register_power_suspend(&cpufreq_intellidemand_early_suspend_info);
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	unregister_power_suspend(&cpufreq_intellidemand_early_suspend_info);
